...
import * as import0 from '../../../../../app/view/directives/charts/bar_chart.directive';
import * as import1 from '@angular/core/src/change_detection/change_detection_util';
import * as import2 from '@angular/core/src/linker/view';
import * as import3 from '@angular/core/src/linker/view_utils';
export class Wrapper_BarChartDirective {
  /*private*/ _eventHandler:Function;
  context:import0.BarChartDirective;
  ...
  constructor(p0:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.BarChartDirective(p0);
  ...
  check_align(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_3,currValue))) {
      ...
      this._changes['align'] = new import1.SimpleChange(this._expr_3,currValue);
