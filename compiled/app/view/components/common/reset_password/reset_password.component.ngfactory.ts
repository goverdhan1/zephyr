...
import * as import0 from '../../../../../../app/view/components/common/reset_password/reset_password.component';
...
export class Wrapper_ResetPasswordComponent {
  ...
  constructor(p0:any) {
    this._changed = false;
    this._changes = {};
    this.context = new import0.ResetPasswordComponent(p0);
  ...
  check_resetPasswordObject(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_0,currValue))) {
      this._changed = true;
      this.context.resetPasswordObject = currValue;
      this._changes['resetPasswordObject'] = new import1.SimpleChange(this._expr_0,currValue);
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean):void {
    ...
    if (emit0) { (this.subscription0 = this.context.resetPasswordUpdate.subscribe(_eventHandler.bind(view,'resetPasswordUpdate'))); }
  }
}
var renderType_ResetPasswordComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_ResetPasswordComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.ResetPasswordComponent>;
  _ResetPasswordComponent_0_3:Wrapper_ResetPasswordComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ResetPasswordComponent_Host0,renderType_ResetPasswordComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'reset-password',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_ResetPasswordComponent0(this.viewUtils,this,0,this._el_0);
    this._ResetPasswordComponent_0_3 = new Wrapper_ResetPasswordComponent(this.injectorGet(import9.FormBuilder,this.parentIndex));
    this.compView_0.create(this._ResetPasswordComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._ResetPasswordComponent_0_3.context);
  }
...
export const ResetPasswordComponentNgFactory:import8.ComponentFactory<import0.ResetPasswordComponent> = new import8.ComponentFactory<import0.ResetPasswordComponent>('reset-password',View_ResetPasswordComponent_Host0,import0.ResetPasswordComponent);
const styles_ResetPasswordComponent:any[] = ([] as any[]);
class View_ResetPasswordComponent1 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_ResetPasswordComponent1,renderType_ResetPasswordComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
...
class View_ResetPasswordComponent2 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_ResetPasswordComponent2,renderType_ResetPasswordComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
...
class View_ResetPasswordComponent3 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_ResetPasswordComponent3,renderType_ResetPasswordComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'span',new import3.InlineArray2(2,'class','show-password-image cursor-pointer'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,' ',(null as any));
...
class View_ResetPasswordComponent4 extends import2.AppView<any> {
  _el_0:any;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import10.ViewContainer) {
    super(View_ResetPasswordComponent4,renderType_ResetPasswordComponent,import6.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'span',new import3.InlineArray2(2,'class','hide-password-image  cursor-pointer'),(null as any));
    this._text_1 = this.renderer.createText(this._el_0,' ',(null as any));
...
var renderType_ResetPasswordComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_ResetPasswordComponent,{});
export class View_ResetPasswordComponent0 extends import2.AppView<import0.ResetPasswordComponent> {
  _el_0:any;
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_ResetPasswordComponent0,renderType_ResetPasswordComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  ...
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    ...
    this._el_49 = import3.createRenderElement(this.renderer,(null as any),'zui-modal-footer',import3.EMPTY_INLINE_ARRAY,(null as any));
    this._text_50 = this.renderer.createText(this._el_49,'\n		    ',(null as any));
    this._el_51 = import3.createRenderElement(this.renderer,this._el_49,'button',new import3.InlineArray4(4,'class','zui-btn zui-btn-primary','type','submit'),(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import13.ModalComponent) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 54)))) { return this._ModalComponent_2_3.context; }
    if (((token === import30.FormGroupDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 55)))) { return this._FormGroupDirective_0_3.context; }
    if (((token === import31.ControlContainer) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 55)))) { return this._ControlContainer_0_4; }
    if (((token === import27.NgControlStatusGroup) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 55)))) { return this._NgControlStatusGroup_0_5.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0_0_0:any = this.context.resetPasswordForm;
    ...
    const currVal_2_0_0:any = 'Reset Password';
    this._ModalComponent_2_3.check_title(currVal_2_0_0,throwOnChange,false);
    const currVal_2_0_1:any = 'reset-password-modal';
    ...
    const currVal_19_1_0:any = this.context.resetPasswordForm.controls['newPassword'];
    this._FormControlDirective_19_5.check_form(currVal_19_1_0,throwOnChange,false);
    const currVal_19_1_1:any = this.context.resetNewPassword;
    ...
    const currVal_34_0_1:any = this._map_88((this.context.resetConfirmPassword !== this.context.resetNewPassword));
    ...
    const currVal_34_2_0:any = this.context.resetPasswordForm.controls['confirmPassword'];
    this._FormControlDirective_34_6.check_form(currVal_34_2_0,throwOnChange,false);
    const currVal_34_2_1:any = this.context.resetConfirmPassword;
    ...
    const currVal_85:any = import3.inlineInterpolate(1,'  ',this.context.resetPasswordObject.upperText,' ');
    if (import3.checkBinding(throwOnChange,this._expr_85,currVal_85)) {
      this.renderer.setText(this._text_9,currVal_85);
      this._expr_85 = currVal_85;
    }
    const currVal_86:any = this.context.newPassword.type;
    if (import3.checkBinding(throwOnChange,this._expr_86,currVal_86)) {
      this.renderer.setElementAttribute(this._el_19,'type',((currVal_86 == null)? (null as any): currVal_86.toString()));
      this._expr_86 = currVal_86;
    }
    this._NgControlStatus_19_7.checkHost(this,this,this._el_19,throwOnChange);
    const currVal_87:any = this.context.confirmPassword.type;
    if (import3.checkBinding(throwOnChange,this._expr_87,currVal_87)) {
      this.renderer.setElementAttribute(this._el_34,'type',((currVal_87 == null)? (null as any): currVal_87.toString()));
      this._expr_87 = currVal_87;
    }
    this._NgControlStatus_34_8.checkHost(this,this,this._el_34,throwOnChange);
    const currVal_89:any = import3.inlineInterpolate(1,'  ',this.context.resetPasswordObject.lowerText,' ');
    if (import3.checkBinding(throwOnChange,this._expr_89,currVal_89)) {
      this.renderer.setText(this._text_42,currVal_89);
      this._expr_89 = currVal_89;
    }
    const currVal_90:any = import3.inlineInterpolate(1,' ',this.context.resetPasswordObject.description,'');
    if (import3.checkBinding(throwOnChange,this._expr_90,currVal_90)) {
      this.renderer.setText(this._text_45,currVal_90);
      this._expr_90 = currVal_90;
    }
    const currVal_91:boolean = (!this.context.resetPasswordForm.valid || (this.context.resetConfirmPassword !== this.context.resetNewPassword));
    if (import3.checkBinding(throwOnChange,this._expr_91,currVal_91)) {
      this.renderer.setElementProperty(this._el_51,'disabled',currVal_91);
  ...
  visitProjectableNodesInternal(nodeIndex:number,ngContentIndex:number,cb:any,ctx:any):void {
    ...
    if (((nodeIndex == 2) && (ngContentIndex == 2))) { cb(this._el_49,ctx); }
  }
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 21)) { return new View_ResetPasswordComponent1(this.viewUtils,this,21,this._anchor_21,this._vc_21); }
    if ((nodeIndex == 23)) { return new View_ResetPasswordComponent2(this.viewUtils,this,23,this._anchor_23,this._vc_23); }
    if ((nodeIndex == 36)) { return new View_ResetPasswordComponent3(this.viewUtils,this,36,this._anchor_36,this._vc_36); }
    if ((nodeIndex == 38)) { return new View_ResetPasswordComponent4(this.viewUtils,this,38,this._anchor_38,this._vc_38); }
    return (null as any);
  }
  handleEvent_0(eventName:string,$event:any):boolean {
    this.markPathToRootAsCheckOnce();
    ...
    if ((eventName == 'ngSubmit')) {
      const pd_sub_0:any = ((<any>this.context.resetPasswordFormSubmit(this.context.resetPasswordForm.value)) !== false);
      result = (pd_sub_0 && result);
    }
    return result;
  }
  handleEvent_19(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'ngModelChange')) {
      const pd_sub_0:any = ((<any>(this.context.resetNewPassword = $event)) !== false);
      result = (pd_sub_0 && result);
    }
    return result;
  }
  handleEvent_34(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'ngModelChange')) {
      const pd_sub_0:any = ((<any>(this.context.resetConfirmPassword = $event)) !== false);
      result = (pd_sub_0 && result);
    }
    return result;
  }
