...
import * as import0 from '../../../../../../app/view/components/tce/operations/tce_export.component';
...
export class Wrapper_TceExportComponent {
  /*private*/ _eventHandler:Function;
  context:import0.TceExportComponent;
  ...
  constructor() {
    this._changed = false;
    this._changes = {};
    this.context = new import0.TceExportComponent();
  ...
  check_exportPrefix(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_6,currValue))) {
      ...
      this._changes['exportPrefix'] = new import1.SimpleChange(this._expr_6,currValue);
  ...
  check_isSearchView(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_7,currValue))) {
      ...
      this._changes['isSearchView'] = new import1.SimpleChange(this._expr_7,currValue);
  ...
  check_isAdvancedSearch(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_8,currValue))) {
      ...
      this._changes['isAdvancedSearch'] = new import1.SimpleChange(this._expr_8,currValue);
  ...
  check_searchText(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_9,currValue))) {
      ...
      this._changes['searchText'] = new import1.SimpleChange(this._expr_9,currValue);
...
var renderType_TceExportComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_TceExportComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.TceExportComponent>;
  _TceExportComponent_0_3:Wrapper_TceExportComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TceExportComponent_Host0,renderType_TceExportComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'zee-export-dialog-tce',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_TceExportComponent0(this.viewUtils,this,0,this._el_0);
    this._TceExportComponent_0_3 = new Wrapper_TceExportComponent();
    this.compView_0.create(this._TceExportComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._TceExportComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.TceExportComponent) && (0 === requestNodeIndex))) { return this._TceExportComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._TceExportComponent_0_3.ngDoCheck(this,this._el_0,throwOnChange);
    this.compView_0.internalDetectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._TceExportComponent_0_3.context.ngAfterViewInit(); } }
  }
...
export const TceExportComponentNgFactory:import8.ComponentFactory<import0.TceExportComponent> = new import8.ComponentFactory<import0.TceExportComponent>('zee-export-dialog-tce',View_TceExportComponent_Host0,import0.TceExportComponent);
const styles_TceExportComponent:any[] = ([] as any[]);
var renderType_TceExportComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,styles_TceExportComponent,{});
export class View_TceExportComponent0 extends import2.AppView<import0.TceExportComponent> {
  ...
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_TceExportComponent0,renderType_TceExportComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_11:any = 'btn btn-secondary';
    if (import3.checkBinding(throwOnChange,this._expr_11,currVal_11)) {
      this.renderer.setElementProperty(this._el_1,'className',currVal_11);
      this._expr_11 = currVal_11;
    }
    const currVal_12:any = import3.inlineInterpolate(1,'zui-export-modal-trigger-',this.context.fieldOptions.id,'');
    if (import3.checkBinding(throwOnChange,this._expr_12,currVal_12)) {
      this.renderer.setElementProperty(this._el_1,'id',currVal_12);
      this._expr_12 = currVal_12;
    }
    const currVal_13:any = ('#zui-export-modal-' + this.context.fieldOptions.id);
    if (import3.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
      this.renderer.setElementAttribute(this._el_1,'data-target',((currVal_13 == null)? (null as any): currVal_13.toString()));
      this._expr_13 = currVal_13;
    }
    const currVal_14:any = import3.inlineInterpolate(1,'',this.context.fieldOptions.header,'');
