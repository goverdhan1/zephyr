...
import * as import0 from 'ng2-bootstrap/dropdown/bs-dropdown.directive';
import * as import1 from '@angular/core/src/change_detection/change_detection_util';
import * as import2 from '@angular/core/src/linker/view';
import * as import3 from '@angular/core/src/linker/view_utils';
export class Wrapper_BsDropdownDirective {
  /*private*/ _eventHandler:Function;
  context:import0.BsDropdownDirective;
  ...
  constructor(p0:any,p1:any,p2:any,p3:any,p4:any,p5:any) {
    this._changed = false;
    this.context = new import0.BsDropdownDirective(p0,p1,p2,p3,p4,p5);
  ...
  check_dropup(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
  ...
  checkHost(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any,throwOnChange:boolean):void {
    const currVal_7:any = this.context.dropup;
    if (import3.checkBinding(throwOnChange,this._expr_7,currVal_7)) {
      view.renderer.setElementClass(el,'dropup',currVal_7);
      this._expr_7 = currVal_7;
    }
    const currVal_8:any = this.context.isOpen;
    if (import3.checkBinding(throwOnChange,this._expr_8,currVal_8)) {
      view.renderer.setElementClass(el,'open',currVal_8);
      this._expr_8 = currVal_8;
    }
    const currVal_9:any = (this.context.isOpen && this.context.isBs4);
