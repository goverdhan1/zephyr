 ...
 *
 * Example:
 * createTag('link', { rel: "manifest", href: "/assts/manifest.json" })
 * // <link rel="manifest" href="/assts/manifest.json">
 ...
 *
 * getHeadTags(ds);
 * // "<link rel="apple-touch-icon" sizes="57x57" href="/assts/icon/apple-icon-57x57.png">"
