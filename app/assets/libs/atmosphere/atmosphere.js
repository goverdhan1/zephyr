...
atmosphere = (function () {
    ...
    atmosphere = {
        ...
        /**
         * Creates an object based on an atmosphere httpStartSubscriber that exposes functions defined by the Websocket interface.
         *
         * @class WebsocketApiAdapter
         * @param {Object} request the request object to build the underlying httpStartSubscriber
         * @constructor
         */
